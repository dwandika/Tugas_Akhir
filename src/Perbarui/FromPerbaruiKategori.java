...
public class FromPerbaruiKategori extends javax.swing.JDialog {

    public FromPerbaruiKategori() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PERBARUI DATA KATEGORI");
    ...
    private void bTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTambahActionPerformed
            ...
            try {
                ...
                statement.setString(2, idKategori);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FromPerbaruiKategori.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            new FromPerbaruiKategori().setVisible(true);
            }
        });
    }
